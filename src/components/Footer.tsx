      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h3 className="font-bold text-lg">RRR Enterprise</h3>
                <p className="text-xs text-background/60">Door to Door Delivery</p>
              </div>
            </div>
            <p className="text-background/70 text-sm mb-4">
              Your trusted partner for quality fertilizers and agricultural
              inputs. Empowering farmers with premium products delivered right
              to their doorstep.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                href="tel:+918229068112"
                className="flex items-center gap-3 text-background/70 hover:text-secondary transition-colors"
              >
                <Phone className="w-5 h-5" />
                <span>+91 8229068112</span>
              </a>
              <a
                href="mailto:qadev432@gmail.com"
                className="flex items-center gap-3 text-background/70 hover:text-secondary transition-colors"
              >
                <Mail className="w-5 h-5" />
                <span>qadev432@gmail.com</span>
              </a>
              <div className="flex items-start gap-3 text-background/70">
                <MapPin className="w-5 h-5 flex-shrink-0 mt-0.5" />
                <span>Triveniganj, Supaul, Bihar - 852139</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-background/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-background/60 text-sm">
            © 2024 RRR Enterprise. All rights reserved.
          </p>
